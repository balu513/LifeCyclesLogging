...
public class C_Fragment extends Fragment {
    private static final String TAG = "C_Fragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.btn_next_frag_d).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((C_Activity)getActivity()).replaceFragment(new D_Fragment(),null);
            }
        });
