...
public class A_Fragment extends Fragment {
    ...
    private static final String TAG = "A_Fragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.btn_launch_b).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((C_Activity)getActivity()).replaceFragment(new B_Fragment(),null);
            }
        });
        return view;
    }
