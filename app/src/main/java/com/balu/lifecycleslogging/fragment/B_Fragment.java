...
public class B_Fragment extends Fragment {
    private static final String TAG = "B_Fragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.btn_next_frag_c).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((C_Activity)getActivity()).replaceFragment(new C_Fragment(),null);
            }
        });
        return view;
    }
